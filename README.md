...
Relational databases have a table based structure where a strict schema is required. SQL is the language used to retrieve data from relation databases.

- [ ] Why do tables need a `primary key`?

This is how realtionships can be established between multiple tables.
